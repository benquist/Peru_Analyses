...
table5 <- stargazer(linear.1, linear.2, linear.3, linear.4, linear.5, linear.6, type="html", 
                    ...
                    omit.stat=c("f", "ser"), ci.separator = " - ", 
                    dep.var.labels.include = FALSE,
                    covariate.labels = c("Aboveground Biomass (kg)", "Temperature 1/kT", "Plot Mean Neff"),
                    model.numbers= FALSE, 
                    column.labels = c("NPP", "GPP", "NPP", "GPP", "NPP", "GPP"),
                    digits = 2)
...
####################################################################################
####################################################################################
####Table_6  TDT shift in trait moments with elevation
######
...
table6N <- stargazer(linear.1, linear.2, linear.3, linear.4, type="html", 
...
table6P <- stargazer(linear.1, linear.2, linear.3, linear.4, type="html", 
                    title="Trait Drivers Theory - Assessing shifts in trait moments", 
                    single.row=FALSE, ci=TRUE,ci.level=0.95, 
                    omit.stat=c("f", "ser"), ci.separator = " - ", 
                    dep.var.labels.include = FALSE,
...
table6C <- stargazer(linear.1, linear.2, linear.3, linear.4, type="html", 
                     title="Trait Drivers Theory - Assessing shifts in trait moments", 
                     single.row=FALSE, ci=TRUE,ci.level=0.95, 
                     omit.stat=c("f", "ser"), ci.separator = " - ", 
                     dep.var.labels.include = FALSE,
...
table6CPhoto <- stargazer(linear.1, linear.2, linear.3, linear.4, type="html", 
                     title="Trait Drivers Theory - Assessing shifts in trait moments", 
                     single.row=FALSE, ci=TRUE,ci.level=0.95, 
                     omit.stat=c("f", "ser"), ci.separator = " - ", 
                     dep.var.labels.include = FALSE,
...
table6SLA <- stargazer(linear.1, linear.2, linear.3, linear.4, type="html", 
                     title="Trait Drivers Theory - Assessing shifts in trait moments", 
                     single.row=FALSE, ci=TRUE,ci.level=0.95, 
                     omit.stat=c("f", "ser"), ci.separator = " - ", 
                     dep.var.labels.include = FALSE,
